...
--changeset OrestHutovych:create-identity-schema
--comment create new identity schema
create schema identity;
--rollback drop schema identity;

--changeset OrestHutovych:create-identity-user_accounts-table
...
--changeset OrestHutovych:create-identity-user_roles-table
...
--changeset OrestHutovych:create-identity-user_accounts_roles-table
...
--changeset OrestHutovych:add-user_accounts_roles-table-constrains
--comment add constrains to user_accounts_roles
...
--rollback alter table identity.user_accounts_roles drop constraints user_accounts_roles__user_roles_fk;
--rollback alter table identity.user_accounts_roles drop constraints user_accounts_roles__user_accounts_fk;
--rollback alter table identity.user_accounts_roles drop constraints user_accounts_roles_unique;


--changeset OrestHutovych:add-data-to-user_roles-table
